export const c_page = {
  ...
  ".pf-c-page": {
    ...
    "c_page__header_brand_md_PaddingRight": {
    ...
    "c_page__header_brand_md_PaddingLeft": {
    ...
    "c_page__header_sidebar_toggle__c_button_md_MarginLeft": {
    ...
    "c_page__header_nav_PaddingLeft": {
    ...
    "c_page__header_nav_md_PaddingLeft": {
    ...
    "c_page__header_nav_lg_PaddingLeft": {
      "name": "--pf-c-page__header-nav--lg--PaddingLeft",
      "value": "0"
    },
    "c_page__header_nav_lg_MarginLeft": {
    ...
    "c_page__header_nav_lg_MarginRight": {
    ...
    "c_page__header_nav_lg_BackgroundColor": {
      "name": "--pf-c-page__header-nav--lg--BackgroundColor",
      "value": "transparent"
    },
    "c_page__header_nav_c_nav__scroll_button_nth_of_type_1_Left": {
      "name": "--pf-c-page__header-nav--c-nav__scroll-button--nth-of-type-1--Left",
      "value": "calc(-1 * (1rem - 0.25rem))",
      "values": [
        "calc(-1 * (--pf-global--spacer--md - --pf-global--spacer--xs))",
        "calc(-1 * ($pf-global--spacer--md - $pf-global--spacer--xs))",
        "calc(-1 * (pf-size-prem(16px) - pf-size-prem(4px)))",
        "calc(-1 * (1rem - 0.25rem))"
      ]
    },
    "c_page__header_nav_c_nav__scroll_button_nth_of_type_1_md_Left": {
    ...
    "c_page__header_nav_c_nav__scroll_button_nth_of_type_1_lg_Left": {
      "name": "--pf-c-page__header-nav--c-nav__scroll-button--nth-of-type-1--lg--Left",
      "value": "0"
    },
    "c_page__header_nav_c_nav__scroll_button_lg_BackgroundColor": {
      "name": "--pf-c-page__header-nav--c-nav__scroll-button--lg--BackgroundColor",
      "value": "#212427",
      "values": [
        "--pf-c-page__header-nav--BackgroundColor",
        "--pf-global--BackgroundColor--dark-300",
        "$pf-global--BackgroundColor--dark-300",
        "$pf-color-black-850",
        "#212427"
    ...
    "c_page__header_nav_c_nav__scroll_button_lg_Top": {
    ...
    "c_page__header_tools_md_MarginRight": {
    ...
    "c_page__main_section_md_PaddingTop": {
    ...
    "c_page__main_section_md_PaddingRight": {
    ...
    "c_page__main_section_md_PaddingBottom": {
    ...
    "c_page__main_section_md_PaddingLeft": {
    ...
    "c_page__main_nav_md_PaddingRight": {
    ...
    "c_page__main_nav_md_PaddingLeft": {
    ...
    "c_page__main_nav_c_nav__scroll_button_nth_of_type_1_Left": {
    ...
    "c_page__main_nav_c_nav__scroll_button_nth_of_type_1_md_Left": {
      "name": "--pf-c-page__main-nav--c-nav__scroll-button--nth-of-type-1--md--Left",
      "value": "calc(-1 * (1.5rem - 0.25rem))",
      "values": [
        "calc(-1 * (--pf-global--spacer--lg - --pf-global--spacer--xs))",
        "calc(-1 * ($pf-global--spacer--lg - $pf-global--spacer--xs))",
        "calc(-1 * (pf-size-prem(24px) - pf-size-prem(4px)))",
        "calc(-1 * (1.5rem - 0.25rem))"
      ]
    },
    "c_page__main_nav_c_nav__scroll_button_nth_of_type_2_Right": {
    ...
    "c_page__main_nav_c_nav__scroll_button_nth_of_type_2_md_Right": {
    ...
    "c_page__main_breadcrumb_md_PaddingRight": {
    ...
    "c_page__main_breadcrumb_md_PaddingLeft": {
