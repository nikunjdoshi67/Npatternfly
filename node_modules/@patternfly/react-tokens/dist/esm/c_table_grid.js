export const c_table_grid = {
  ".pf-c-table[class*=\"pf-m-grid\"]": {
    ...
    "c_table_tbody_responsive_MarginTop": {
    ...
    "c_table_tbody_m_expanded_before_Top": {
    ...
    "c_table_tbody_responsive_BorderWidth": {
    ...
    "c_table_tr_responsive_BorderWidth": {
    ...
    "c_table_tr_responsive_last_child_BorderWidth": {
    ...
    "c_table_tr_responsive_md_PaddingRight": {
    ...
    "c_table_tr_responsive_md_PaddingLeft": {
    ...
    "c_table_cell_m_grid_hidden_visible_Display": {
    ...
    "c_table_cell_th_responsive_PaddingTop": {
    ...
    "c_table__toggle_m_expanded__icon_Transform": {
  ...
  ".pf-m-grid.pf-c-table [data-label]": {
    "c_table_cell_hidden_visible_Display": {
      ...
      "value": "grid",
      "values": [
        "--pf-c-table-cell--m-grid--hidden-visible--Display",
        "grid"
      ]
    }
  },
