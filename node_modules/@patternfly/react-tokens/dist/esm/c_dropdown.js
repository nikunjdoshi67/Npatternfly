export const c_dropdown = {
  ".pf-c-dropdown": {
    ...
    "c_dropdown__toggle_BorderWidth": {
    ...
    "c_dropdown__toggle_BorderTopColor": {
    ...
    "c_dropdown__toggle_BorderRightColor": {
    ...
    "c_dropdown__toggle_BorderBottomColor": {
    ...
    "c_dropdown__toggle_BorderLeftColor": {
    ...
    "c_dropdown__toggle_hover_BorderBottomColor": {
    ...
    "c_dropdown__toggle_active_BorderBottomWidth": {
    ...
    "c_dropdown__toggle_active_BorderBottomColor": {
    ...
    "c_dropdown__toggle_focus_BorderBottomWidth": {
    ...
    "c_dropdown__toggle_focus_BorderBottomColor": {
    ...
    "c_dropdown__toggle_expanded_BorderBottomWidth": {
    ...
    "c_dropdown__toggle_expanded_BorderBottomColor": {
    ...
    "c_dropdown__toggle_m_plain_BorderColor": {
    ...
    "c_dropdown__toggle_m_split_button__toggle_check__input_Transform": {
    ...
    "c_dropdown_m_top_m_expanded__toggle_icon_Transform": {
    ...
    "c_dropdown_m_top__menu_Transform": {
    ...
    "c_dropdown__c_divider_MarginTop": {
    ...
    "c_dropdown__c_divider_MarginBottom": {
    ...
    "c_dropdown__separator_BackgroundColor": {
    ...
    "c_dropdown__separator_MarginTop": {
    ...
    "c_dropdown__separator_MarginBottom": {
    ...
    "c_dropdown__group_first_child_PaddingTop": {
  ...
  ".pf-c-dropdown__group + .pf-c-dropdown__group": {
    "c_dropdown__group_PaddingTop": {
      ...
      "value": "0.5rem",
      "values": [
        "--pf-c-dropdown__group--group--PaddingTop",
        "--pf-global--spacer--sm",
        "$pf-global--spacer--sm",
        "pf-size-prem(8px)",
        "0.5rem"
