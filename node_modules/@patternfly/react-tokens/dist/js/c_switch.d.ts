export const c_switch: {
  ".pf-c-switch": {
    ...
    "c_switch__toggle_icon_PaddingLeft": {
    ...
    "c_switch__toggle_icon_Transform": {
    ...
    "c_switch__input_checked__toggle_before_Transform": {
      "name": "--pf-c-switch__input--checked__toggle--before--Transform",
      "value": "translateX(calc(100% + 0.125rem))",
      "values": [
        "translateX(calc(100% + --pf-c-switch__toggle-icon--Offset))",
