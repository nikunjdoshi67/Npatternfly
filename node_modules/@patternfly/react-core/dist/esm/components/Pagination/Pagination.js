...
export class Pagination extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", Object.assign({ ref: this.paginationRef, className: css(styles.pagination, variant === PaginationVariant.bottom && styles.modifiers.footer, isCompact && styles.modifiers.compact, className), id: `${widgetId}-${paginationId++}` }, getOUIAProps('Pagination', ouiaId), props),
