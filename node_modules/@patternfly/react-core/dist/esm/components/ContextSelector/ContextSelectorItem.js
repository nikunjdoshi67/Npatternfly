...
export class ContextSelectorItem extends React.Component {
    ...
    render() {
        ...
        const _a = this.props, { className, children, isHovered, onClick, isDisabled, index, sendRef } = _a, props = __rest(_a, ["className", "children", "isHovered", "onClick", "isDisabled", "index", "sendRef"]);
        return (React.createElement(ContextSelectorContext.Consumer, null, ({ onSelect }) => (React.createElement("li", { role: "none" },
            React.createElement("button", Object.assign({ className: css(styles.contextSelectorMenuListItem, isDisabled && styles.modifiers.disabled, isHovered && styles.modifiers.hover, className), ref: this.ref, onClick: event => {
                    if (!isDisabled) {
                        onClick(event);
