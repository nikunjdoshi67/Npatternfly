...
export class Switch extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("label", Object.assign({ className: css(styles.switch, className), htmlFor: this.id }, getOUIAProps('Switch', ouiaId)),
            ...
            label !== '' ? (React.createElement(React.Fragment, null,
                ...
                React.createElement("span", { className: css(styles.switchLabel, styles.modifiers.off), id: isAriaLabelledBy ? `${this.id}-off` : null, "aria-hidden": "true" }, labelOff || label))) : label !== '' && labelOff !== '' ? (React.createElement(React.Fragment, null,
                React.createElement("span", { className: css(styles.switchToggle) }),
                React.createElement("span", { className: css(styles.switchLabel, styles.modifiers.on), id: isAriaLabelledBy ? `${this.id}-on` : null, "aria-hidden": "true" }, label),
                React.createElement("span", { className: css(styles.switchLabel, styles.modifiers.off), id: isAriaLabelledBy ? `${this.id}-off` : null, "aria-hidden": "true" }, labelOff))) : (React.createElement("span", { className: css(styles.switchToggle) },
