...
export class DropdownToggleCheckbox extends React.Component {
    ...
    render() {
        ...
        const _a = this.props, { className, onChange, isValid, isDisabled, isChecked, ref, checked, children } = _a, props = __rest(_a, ["className", "onChange", "isValid", "isDisabled", "isChecked", "ref", "checked", "children"]);
