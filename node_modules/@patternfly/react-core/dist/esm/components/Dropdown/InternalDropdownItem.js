...
export class InternalDropdownItem extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(DropdownContext.Consumer, null, ({ onSelect, itemClass, disabledClass, hoverClass }) => {
