...
export const EmptyState = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: css(styles.emptyState, isFullHeight && styles.modifiers.fullHeight, variant === 'small' && styles.modifiers.sm, variant === 'large' && styles.modifiers.lg, variant === 'xl' && styles.modifiers.xl, className) }, props),
