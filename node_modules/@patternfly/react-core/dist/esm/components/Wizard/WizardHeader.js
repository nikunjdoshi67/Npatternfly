...
export const WizardHeader = ({ onClose = () => undefined, title, description, closeButtonAriaLabel, titleId, descriptionId }) => (React.createElement("div", { className: css(styles.wizardHeader) },
    React.createElement(Button, { variant: "plain", className: css(styles.wizardClose), "aria-label": closeButtonAriaLabel, onClick: onClose },
