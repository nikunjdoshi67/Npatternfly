...
.pf-c-chip-group {
  ...
  --pf-c-chip-group--m-toolbar--BackgroundColor: var(--pf-global--BackgroundColor--200);
...
.pf-c-form-control[readonly], .pf-c-form-control[readonly].pf-m-hover, .pf-c-form-control[readonly]:hover:not(.pf-m-success):not([aria-invalid="true"]), .pf-c-form-control[readonly].pf-m-focus, .pf-c-form-control[readonly]:focus:not(.pf-m-success):not([aria-invalid="true"]) {
...
.pf-c-button.pf-m-control:hover, .pf-c-button.pf-m-control.pf-m-hover {
...
.pf-c-button.pf-m-control:focus, .pf-c-button.pf-m-control.pf-m-focus {
...
.pf-c-data-list {
  ...
  --pf-c-data-list__item-item--BorderTopColor: var(--pf-global--BorderColor--300);
  --pf-c-data-list__item-item--BorderTopWidth: 0.5rem;
  ...
  --pf-c-data-list__item-item--sm--BorderTopWidth: var(--pf-global--BorderWidth--sm);
  --pf-c-data-list__item-item--sm--BorderTopColor: var(--pf-global--BorderColor--100);
...
.pf-c-dropdown__menu-item.pf-m-text:hover, .pf-c-dropdown__menu-item.pf-m-text.pf-m-hover, .pf-c-dropdown__menu-item.pf-m-text:focus, .pf-c-dropdown__menu-item.pf-m-text.pf-m-focus {
  --pf-c-dropdown__menu-item--BackgroundColor: transparent; }
...
.pf-c-page {
  ...
  --pf-c-page__main-nav--c-nav__scroll-button--nth-of-type-1--md--Left: calc(-1 * (var(--pf-global--spacer--lg) - var(--pf-global--spacer--xs)));
  --pf-c-page__main-nav--c-nav__scroll-button--nth-of-type-2--Right: calc(-1 * (var(--pf-global--spacer--md) - var(--pf-global--spacer--xs)));
  --pf-c-page__main-nav--c-nav__scroll-button--nth-of-type-2--md--Right: calc(-1 * (var(--pf-global--spacer--lg) - var(--pf-global--spacer--xs)));
...
.pf-c-tabs {
  ...
  --pf-c-tabs__button--OutlineOffset: calc(-1 * 0.375rem);
...
.pf-c-tabs.pf-m-fill .pf-c-tabs__button {
  flex-basis: 100%;
  justify-content: center; }
...
.pf-c-tabs.pf-m-scrollable.pf-m-secondary, .pf-c-tabs.pf-m-scrollable.pf-m-no-border {
  --pf-c-tabs--before--BorderWidth: 0; }

.pf-c-tabs.pf-m-box .pf-c-tabs__button, .pf-c-tabs.pf-m-vertical .pf-c-tabs__button {
...
.pf-c-tabs.pf-m-box.pf-m-vertical .pf-c-tabs__button::after {
  top: calc(var(--pf-c-tabs__button--before--BorderWidth) * -1); }

.pf-c-tabs.pf-m-box.pf-m-vertical .pf-c-tabs__item:first-child .pf-c-tabs__button::after,
.pf-c-tabs.pf-m-box.pf-m-vertical .pf-c-tabs__item.pf-m-current + .pf-c-tabs__item .pf-c-tabs__button::after {
  top: 0; }
...
.pf-c-tabs__button .pf-c-tabs__item-icon,
.pf-c-tabs__button .pf-c-tabs__item-text {
  margin-right: var(--pf-c-tabs__button--child--MarginRight); }

.pf-c-tabs__button .pf-c-tabs__item-icon:last-child,
.pf-c-tabs__button .pf-c-tabs__item-text:last-child {
...
.pf-c-data-toolbar {
  ...
  --pf-c-data-toolbar__expandable-content--m-expanded--GridRowGap: var(--pf-global--gutter--md);
