...
class InternalDropdownItem extends React.Component {
    ...
    render() {
        ...
        const _a = this.props, { className, children, isHovered, context, onClick, component, variant, role, isDisabled, index, href, tooltip, tooltipProps, id, componentID, listItemClassName, additionalChild, customChild, enterTriggersArrowDown } = _a, additionalProps = tslib_1.__rest(_a, ["className", "children", "isHovered", "context", "onClick", "component", "variant", "role", "isDisabled", "index", "href", "tooltip", "tooltipProps", "id", "componentID", "listItemClassName", "additionalChild", "customChild", "enterTriggersArrowDown"]);
        ...
        return (React.createElement(dropdownConstants_1.DropdownContext.Consumer, null, ({ onSelect, itemClass, disabledClass, hoverClass }) => {
            if (this.props.role === 'separator') {
                classes = react_styles_1.css(variant === 'icon' && dropdown_1.default.modifiers.icon, className);
            }
            else {
                classes = react_styles_1.css(variant === 'icon' && dropdown_1.default.modifiers.icon, className, isDisabled && disabledClass, isHovered && hoverClass, itemClass);
            }
            if (customChild) {
            ...
            return (React.createElement("li", { className: listItemClassName || null, role: role, onKeyDown: this.onKeyDown, onClick: (event) => {
                ...
                renderWithTooltip(React.isValidElement(component) ? (React.cloneElement(component, Object.assign({ href, id: componentID, className: classes }, additionalProps))) : (React.createElement(Component, Object.assign({}, additionalProps, { href: href, ref: this.ref, className: classes, id: componentID }), children))),
