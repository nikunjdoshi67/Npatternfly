...
class DropdownToggleCheckbox extends React.Component {
    ...
    render() {
        ...
        const _a = this.props, { className, onChange, isValid, isDisabled, isChecked, ref, checked, children } = _a, props = tslib_1.__rest(_a, ["className", "onChange", "isValid", "isDisabled", "isChecked", "ref", "checked", "children"]);
        ...
        return (React.createElement("label", { className: react_styles_1.css(dropdown_1.default.dropdownToggleCheck, className), htmlFor: props.id },
            React.createElement("input", Object.assign({}, props, (this.calculateChecked() !== undefined && { onChange: this.handleChange }), { type: "checkbox", ref: ref, "aria-invalid": !isValid, disabled: isDisabled, checked: this.calculateChecked() })),
            text));
    }
}
