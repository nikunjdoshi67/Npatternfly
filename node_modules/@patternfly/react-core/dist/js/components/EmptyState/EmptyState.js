...
exports.EmptyState = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: react_styles_1.css(empty_state_1.default.emptyState, isFullHeight && empty_state_1.default.modifiers.fullHeight, variant === 'small' && empty_state_1.default.modifiers.sm, variant === 'large' && empty_state_1.default.modifiers.lg, variant === 'xl' && empty_state_1.default.modifiers.xl, className) }, props),
