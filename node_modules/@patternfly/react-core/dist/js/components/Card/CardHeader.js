...
exports.CardHeader = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: react_styles_1.css(card_1.default.cardHeader, title_1.default.title, title_1.default.modifiers.md, className) }, props), children));
};
