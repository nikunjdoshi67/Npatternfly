...
class Page extends React.Component {
    constructor(props) {
        ...
        this.handleResize = () => {
            ...
            const mobileView = windowSize < Number.parseInt(global_breakpoint_md_1.default.value, 10);
            if (onPageResize) {
    ...
    render() {
        ...
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        onPageResize, mainAriaLabel } = _a, rest = tslib_1.__rest(_a, ["breadcrumb", "className", "children", "header", "sidebar", "skipToContent", "role", "mainContainerId", "isManagedSidebar", "defaultManagedSidebarIsOpen", "onPageResize", "mainAriaLabel"]);
        ...
        return (React.createElement(exports.PageContextProvider, { value: context },
            React.createElement("div", Object.assign({}, rest, { className: react_styles_1.css(page_1.default.page, className) }),
                ...
                header,
                sidebar,
                React.createElement("main", { role: role, id: mainContainerId, className: react_styles_1.css(page_1.default.pageMain), tabIndex: -1, "aria-label": mainAriaLabel },
