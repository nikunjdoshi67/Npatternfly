...
exports.PageSection = (_a) => {
    var { className = '', children, variant = 'default', type = 'default', noPadding = false, isFilled } = _a, props = tslib_1.__rest(_a, ["className", "children", "variant", "type", "noPadding", "isFilled"]);
    const variantType = {
    ...
    return (React.createElement("section", Object.assign({}, props, { className: react_styles_1.css(variantType[type], noPadding && page_1.default.modifiers.noPadding, variantStyle[variant], isFilled === false && page_1.default.modifiers.noFill, isFilled === true && page_1.default.modifiers.fill, className) }), children));
};
