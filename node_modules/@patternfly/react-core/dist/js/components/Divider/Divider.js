...
exports.Divider = (_a) => {
    var { className = '', component = DividerVariant.hr } = _a, props = tslib_1.__rest(_a, ["className", "component"]);
    const Component = component;
    return (React.createElement(Component, Object.assign({ className: react_styles_1.css(divider_1.default.divider, className) }, (component !== 'hr' && { role: 'separator' }), props)));
};
