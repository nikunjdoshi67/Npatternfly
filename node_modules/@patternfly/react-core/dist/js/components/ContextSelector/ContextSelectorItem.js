...
class ContextSelectorItem extends React.Component {
    ...
    render() {
        ...
        const _a = this.props, { className, children, isHovered, onClick, isDisabled, index, sendRef } = _a, props = tslib_1.__rest(_a, ["className", "children", "isHovered", "onClick", "isDisabled", "index", "sendRef"]);
        return (React.createElement(contextSelectorConstants_1.ContextSelectorContext.Consumer, null, ({ onSelect }) => (React.createElement("li", { role: "none" },
            React.createElement("button", Object.assign({ className: react_styles_1.css(context_selector_1.default.contextSelectorMenuListItem, isDisabled && context_selector_1.default.modifiers.disabled, isHovered && context_selector_1.default.modifiers.hover, className), ref: this.ref, onClick: event => {
                    if (!isDisabled) {
                        onClick(event);
