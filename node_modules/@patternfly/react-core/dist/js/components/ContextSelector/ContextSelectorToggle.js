...
class ContextSelectorToggle extends React.Component {
    ...
    render() {
        ...
        props = tslib_1.__rest(_a, ["className", "toggleText", "isOpen", "isFocused", "isActive", "isHovered", "onToggle", "id", "onEnter", "parentRef"]);
        return (React.createElement("button", Object.assign({}, props, { id: id, ref: this.toggle, className: react_styles_1.css(context_selector_1.default.contextSelectorToggle, isFocused && context_selector_1.default.modifiers.focus, isHovered && context_selector_1.default.modifiers.hover, isActive && context_selector_1.default.modifiers.active, className), type: "button", onClick: event => onToggle(event, !isOpen), "aria-expanded": isOpen, onKeyDown: this.onKeyDown }),
            React.createElement("span", { className: react_styles_1.css(context_selector_1.default.contextSelectorToggleText) }, toggleText),
            React.createElement(caret_down_icon_1.default, { className: react_styles_1.css(context_selector_1.default.contextSelectorToggleIcon), "aria-hidden": true })));
    }
}
