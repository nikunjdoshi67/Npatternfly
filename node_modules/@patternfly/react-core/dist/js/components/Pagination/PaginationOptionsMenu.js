    ...
    constructor(props) {
        ...
        this.renderItems = () => {
            ...
            return perPageOptions.map(({ value, title }) => (React.createElement(Dropdown_1.DropdownItem, { key: value, component: "button", "data-action": `per-page-${value}`, className: react_styles_1.css(perPage === value && 'pf-m-selected'), onClick: event => this.handleNewPerPage(event, value) },
                title,
                React.createElement("span", { className: react_styles_1.css(pagination_1.default.paginationMenuText) }, ` ${perPageSuffix}`),
                perPage === value && (React.createElement("i", { className: react_styles_1.css(options_menu_1.default.optionsMenuMenuItemIcon) },
