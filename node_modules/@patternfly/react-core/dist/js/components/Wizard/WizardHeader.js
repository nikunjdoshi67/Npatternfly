...
exports.WizardHeader = ({ onClose = () => undefined, title, description, closeButtonAriaLabel, titleId, descriptionId }) => (React.createElement("div", { className: react_styles_1.css(wizard_1.default.wizardHeader) },
    React.createElement(Button_1.Button, { variant: "plain", className: react_styles_1.css(wizard_1.default.wizardClose), "aria-label": closeButtonAriaLabel, onClick: onClose },
