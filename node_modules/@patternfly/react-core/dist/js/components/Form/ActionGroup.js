...
exports.ActionGroup = (_a) => {
    ...
    const classesHorizontal = react_styles_1.css(form_1.default.formHorizontalGroup);
    const formActionsComponent = React.createElement("div", { className: react_styles_1.css(form_1.default.formActions) }, children);
    return (React.createElement(FormContext_1.FormContext.Consumer, null, ({ isHorizontal }) => (React.createElement("div", Object.assign({}, props, { className: customClassName }), isHorizontal ? React.createElement("div", { className: classesHorizontal }, formActionsComponent) : formActionsComponent))));
};
