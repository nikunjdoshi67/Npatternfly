...
class SelectToggle extends React.Component {
    ...
    render() {
        ...
        const _a = this.props, { className, children, isOpen, isFocused, isActive, isHovered, isPlain, isDisabled, variant, onToggle, onEnter, onClose, handleTypeaheadKeys, parentRef, id, type, hasClearButton, 'aria-labelledby': ariaLabelledBy, 'aria-label': ariaLabel } = _a, props = tslib_1.__rest(_a, ["className", "children", "isOpen", "isFocused", "isActive", "isHovered", "isPlain", "isDisabled", "variant", "onToggle", "onEnter", "onClose", "handleTypeaheadKeys", "parentRef", "id", "type", "hasClearButton", 'aria-labelledby', 'aria-label']);
        ...
        return (React.createElement(React.Fragment, null,
            !isTypeahead && (React.createElement("button", Object.assign({}, props, toggleProps, { ref: this.toggle, type: type, className: react_styles_1.css(select_1.default.selectToggle, isFocused && select_1.default.modifiers.focus, isHovered && select_1.default.modifiers.hover, isDisabled && select_1.default.modifiers.disabled, isActive && select_1.default.modifiers.active, isPlain && select_1.default.modifiers.plain, className), 
